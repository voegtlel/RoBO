...
class NoiseTask(BaseTask):
    ...
    def __init__(self, base_task, noise_scale=1):
        ...
        if base_task.do_scaling:
            super(NoiseTask, self).__init__(base_task.original_X_lower, base_task.original_X_upper, base_task.original_opt, base_task.original_fopt, do_scaling=base_task.do_scaling)
        else:
            super(NoiseTask, self).__init__(base_task.X_lower, base_task.X_upper, base_task.opt, base_task.fopt, do_scaling=base_task.do_scaling)
